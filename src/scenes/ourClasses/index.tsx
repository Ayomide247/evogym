        ...
        >
         <motion.div 
            ...
            <div className='md:w-3/5'>
                ...
                <p className='py-5'>Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown ...</p>
            </div>
        </motion.div>  
